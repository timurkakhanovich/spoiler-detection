...
from AttentiveLSTM.modules.data.dataset import (
...
from AttentiveLSTM.modules.pipeline_config.utils import (
    Metrics,
    set_seed, 
    set_split,
    get_class_weights,
...
from AttentiveLSTM.modules.pipeline_config.model_config import ModelConfig
from AttentiveLSTM.modules.pipeline_config.train import train


def main_command_line_args():
    set_seed(42)
    CHECKPOINT_PATH = Path('RNN_checkpoints/')
