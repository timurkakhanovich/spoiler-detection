...
from LSTM.modules.models.model import LSTMModel, BiLSTMModel
from LSTM.modules.pipeline_config.utils import BPEMB_EN, set_device
...
class ModelConfig:
    ...
    * if checkpoint is not chosen: LR, BATCH_SIZE, NUM_EPOCHS, DEVICE
    ...
    def __init__(self, checkpoint_path=Path('.')):
        ...
        self.model = BiLSTMModel(BPEMB_EN, hid_size=128)
